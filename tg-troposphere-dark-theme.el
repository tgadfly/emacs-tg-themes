 ...
 (let ((class '((class color) (min-colors 89)))
   ...
   'tg-troposphere-dark
	...
	`(cursor ((,class (:background ,bg3))))
        ...
        `(mode-line ((,class (:bold nil :box nil :foreground ,fg1 :background ,bg1))))
        `(mode-line-inactive ((,class (:box nil :foreground ,key3 :background ,bg1 :weight normal))))
        `(mode-line-buffer-id ((,class (:bold nil :box nil :foreground ,func :background ,bg1))))
	`(mode-line-highlight ((,class (:foreground ,keyword :box nil :background ,bg1))))
        `(mode-line-emphasis ((,class (:box nil :foreground ,fg1 :background ,bg1))))
	...
	`(org-hide ((,class (:foreground ,fg4))))
        `(org-level-1 ((,class (:bold nil :foreground ,fg2))))
        ...
        `(org-todo ((,class (:box nil :foreground ,keyword :bold nil))))
        `(org-done ((,class (:box nil :foreground ,comment))))
...
(provide-theme 'tg-troposphere-dark)
