;;; tg-exosphere-dark-theme.el --- Emacs theme with a dark background.
 ...
 (let ((class '((class color) (min-colors 89)))
   ...
   'tg-exosphere-dark
	...
	`(cursor ((,class (:background ,bg3))))
        ...
        `(mode-line ((,class (:bold t :box nil :foreground ,fg1 :background ,bg1))))
        `(mode-line-inactive ((,class (:box nil :foreground ,key3 :background ,bg1 :weight normal))))
        `(mode-line-buffer-id ((,class (:bold t :box nil :foreground ,func :background ,bg1))))
	...
	`(org-hide ((,class (:foreground ,fg4))))
        ...
        `(org-done ((,class (:box nil :foreground ,fg1))))
...
(provide-theme 'tg-exosphere-dark)

;; Local Variables:
;; no-byte-compile: t
;; End:

;;; tg-exosphere-dark-theme.el ends here
